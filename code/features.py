...
| ``trends_z_26``    | External · Macro-analog         | z-score of SVI vs. own trailing 26w                 |
...
| ``mom_52_4``       | Internal · Fundamental          | cumulative return t−52 → t−4 (skips recent month)   |
...
FEATURE_TAGS: dict[str, tuple[str, str]] = {
    "asvi":          ("external", "macro-analog"),
    "trends_z_26":   ("external", "macro-analog"),
    "trends_chg_4":  ("external", "macro-analog"),
