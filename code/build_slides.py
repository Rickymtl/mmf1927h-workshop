...
# 18 close
slide("close", "", "", """
<h1 class="thanks-big">Thank you</h1>
...
.thanks-big{font-size:clamp(44px,6.5vw,88px);font-weight:800;letter-spacing:-.025em;color:#f0b72f;margin:0}
.slide.close .sub{margin-top:.15em}
.slide.close .names{margin-top:2.4em}
...
@media print{
 ...
 html,body{background:#0d1117!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}
 .slide{display:flex!important;page-break-after:always;break-after:page;
        width:1280px;height:720px;padding:34px 52px;overflow:hidden}
 .slide:last-child{page-break-after:auto}
 #nav,#bar{display:none}
 .inner{max-width:1176px}
}
"""
